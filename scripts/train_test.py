...
def do_extract():
    ...
    layer_names += [','.join(['fc1_12a', 'fc1_12b', 'rnorm4_13a', 'rnorm4_13b','fc2_14a', 'fc2_14b',  'rnorm5_15a', 'rnorm5_15b'])]
    layer_names += [','.join(['rnorm5_15a', 'rnorm5_15b'])]
    ...
    model_names = ["rosch_trained"]
    #data_paths = ["hvm_batches_138_permuted", "synthetic_batches_large"]
    #data_paths = ["hvm_batches_138_permuted","imagenet_challenge_138"]
    data_paths = ["synthetic_batches_large"]
    
    #resize_tos = ['[138, 138]', '[138, 138, 3]']
    #resize_tos = ['[138, 138]', '[138, 138]']
    resize_tos = ['[138, 138]']
    ##batch_limits = [22, 50]
    batch_limits = [50]
    ...
    queries = ['{"experiment_data.experiment_id": "synthetic_training_rosch_category"}']
    fs_names = ['convnet_checkpoint_fs'] #'convnet_checkpoint_fs'] #, 'reference_models']
    #dsetmods = ['dldata.stimulus_sets.hvm', 'dldata.stimulus_sets.synthetic.synthetic_datasets']
    dsetmods = ['dldata.stimulus_sets.synthetic.synthetic_datasets']
    #dsetobjs = ['HvMWithDiscfade', 'TrainingDatasetLarge']
    dsetobjs = ['TrainingDatasetLarge']
    #mattrs = ['category', 'category']
    #dsetmods = ['dldata.stimulus_sets.hvm','imagenet.dldatasets']
    #dsetobjs = ['HvMWithDiscfade','ChallengeSynsets2013_offline']
    #mattrs = ['category', 'synset']
    mattrs = ['category']
