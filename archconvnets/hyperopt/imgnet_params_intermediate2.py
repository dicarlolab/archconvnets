...
filter3_size = scope.int(hp_quniform('filter3_shape', 2, 5, 1))

num_filters4 = scope.int(hp_qloguniform('num_filters4',np.log(16), np.log(192), q=16))
filter4_size = scope.int(hp_quniform('filter4_shape', 2, 4, 1))
...
rnorm1_size = scope.int(hp_quniform('rnorm1_size', 2, 8, 1))
rnorm2_size = scope.int(hp_quniform('rnorm2_size', 2, 8, 1))
rnorm3_size = scope.int(hp_quniform('rnorm3_size', 2, 8, 1))
