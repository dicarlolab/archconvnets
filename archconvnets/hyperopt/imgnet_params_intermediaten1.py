...
filter1_size = '11' #scope.int(hp_quniform('filter1_shape', 10, 12, 1))

num_filters2 = scope.int(hp_qloguniform('num_filters2',np.log(250), np.log(256), q=16))
filter2_size = '5' #scope.int(hp_quniform('filter2_shape', 4, 6, 1))

num_filters3 = scope.int(hp_qloguniform('num_filters3',np.log(350), np.log(384), q=16))
filter3_size = '3' #scope.int(hp_quniform('filter3_shape', 3, 4, 1))
...
learning_params_template = OrderedDict([('conv1', OrderedDict([('epsw', hp_choice('epsw_conv1', [1e-2])),
                                        ...
                                        ('rnorm1', OrderedDict([('scale', hp_choice('rnorm1_scale', [0.0001])),
                                                                ('pow', 0.75)])), #hp_uniform('rnorm1_pow', 0.6, 0.95))])),
                                        ('conv2', OrderedDict([('epsw', hp_choice('epsw_conv2', [1e-2])),
                                                               ('epsb', hp_choice('epsb_conv2', [0])),
                                                               ('momw', 0.9),
                                                               ('momb', 0),
                                                               ('wc', hp_choice('wc_conv2', [0.0005]))])),
                                        ('rnorm2', OrderedDict([('scale', hp_choice('rnorm2_scale', [0.0001])),
                                                                ('pow', 0.75)])), #hp_uniform('rnorm1_pow', 0.6, 0.95))])), #('pow', hp_uniform('rnorm2_pow', 0.6, 0.95))])),
                                        ('conv3', OrderedDict([('epsw', hp_choice('epsw_conv3', [1e-2])),
                                                               ('epsb', hp_choice('epsb_conv3', [0])),
                                                               ('momw', 0.9),
                                                               ('momb', 0),
                                                               ('wc', hp_choice('wc_conv3', [0.0005]))])),
                                        ('rnorm3', OrderedDict([('scale', hp_choice('rnorm3_scale', [0.0001])),
                                                                ('pow', 0.75)])), #hp_uniform('rnorm1_pow', 0.6, 0.95))])),('pow', hp_uniform('rnorm3_pow', 0.6, 0.95))])),                                
