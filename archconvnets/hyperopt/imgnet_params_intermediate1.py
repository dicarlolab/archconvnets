...
filter1_size = scope.int(hp_quniform('filter1_shape', 9, 12, 1))

num_filters2 = scope.int(hp_qloguniform('num_filters2',np.log(110), np.log(128), q=16))
filter2_size = scope.int(hp_quniform('filter2_shape', 4, 7, 1))

num_filters3 = scope.int(hp_qloguniform('num_filters3',np.log(180), np.log(192), q=16))
filter3_size = scope.int(hp_quniform('filter3_shape', 3, 4, 1))

num_filters4 = scope.int(hp_qloguniform('num_filters4',np.log(180), np.log(192), q=16))
filter4_size = scope.int(hp_quniform('filter4_shape', 3, 4, 1))

num_filters5 = scope.int(hp_qloguniform('num_filters5',np.log(180), np.log(192), q=16))
filter5_size = scope.int(hp_quniform('filter5_shape', 3, 3, 1))
...
layer_def_template = OrderedDict([('data', OrderedDict([('type', 'data'),
             ...
             ('conv1', OrderedDict([('type', 'conv'),
                                    ...
                                    ('neuron', 'relu'),
                                    ('initw', hp_choice('initw_conv1', [1e-1])), #('partialsum', 1),
                                    ('sharedbiases', 1)])),
             ...
             ('conv2', OrderedDict([('type', 'conv'),
                                    ...
                                    ('channels', num_filters1),
                                    ('neuron', 'relu'),
                                    ('initw', hp_choice('initw_conv2', [1e-1])), #('partialsum', 1),
                                    ('sharedbiases', 1)])),
              ...
              ('conv3', hp_choice('conv3', [OrderedDict([('type', 'conv'),
                                             ...
                                             ('channels', num_filters2),
                                             ('neuron', 'relu'),
                                             ('initw', hp_choice('initw_conv3', [1e-1])), #('partialsum', 1),
                                             ('sharedbiases', 1)]),
             ...
             ('conv4', hp_choice('conv4', [OrderedDict([('type', 'conv'),
                                                 ...
                                                 ('neuron', 'relu'),
                                                 ('initw', hp_choice('initw_conv4', [1e-1])), #('partialsum', 1),
                                                 ('sharedbiases', 1)]),
                                           OrderedDict([('type', 'local'),
                                                 ('inputs', 'conv3'),
                                                 ('filters', num_filters4),
            ...
            ('conv5', hp_choice('conv5', [OrderedDict([('type', 'conv'),
                                                 ...
                                                 ('neuron', 'relu'),
                                                 ('initw', hp_choice('initw_conv5', [1e-1])), #('partialsum', 1),
                                                 ('sharedbiases', 1)]),
                                           OrderedDict([('type', 'local'),
                                                 ('inputs', 'conv4'),
                                                 ('filters', num_filters5),
            ...
            ('rnorm3', hp_choice('rn3', [OrderedDict([('inputs', 'conv5'),
             ...
             ('pool3', hp_choice('pool3', [OrderedDict([('inputs', 'rnorm3'),
                                           ...
                                           OrderedDict([('type', 'pool'),
                                                        ...
                                                        ('outputsx', 0),
                                                        ('channels', num_filters5)])])),
             ('fc1', hp_choice('fc1', [OrderedDict([('type', 'fc'),
                                                     ('outputs', scope.int(hp_quniform('num_outputs_fc1', 2024, 4096, 1))),
                                                     ('inputs', 'pool3'),
                                                     ('initw', hp_choice('initw_fc1', [1e-1])),
                                                     ('neuron', 'relu')]),
                                        OrderedDict([('inputs', 'pool3'),
                                                     ('type', None)])])),
             ('fc2', hp_choice('fc2', [OrderedDict([('type', 'fc'),
                                                     ('outputs', scope.int(hp_quniform('num_outputs_fc2', 2024, 4096, 1))),
                                                     ('inputs', 'fc1'),
                                                     ('initw', hp_choice('initw_fc2', [1e-1])),
                                                     ('neuron', 'relu')]),
                                        OrderedDict([('inputs', 'fc1'),
                                                     ('type', None)])])),
             ('fc10', OrderedDict([('type', 'fc'),
                                   ('outputs', 999),
                                   ('inputs', 'fc2'),
                                   ('initw', hp_choice('initw_fc10', [1e-1]))])),
...
learning_params_template = OrderedDict([('conv1', OrderedDict([('epsw', hp_choice('epsw_conv1', [1e-1])),
                                        ...
                                        ('conv2', OrderedDict([('epsw', hp_choice('epsw_conv2', [1e-1])),
                                                               ('epsb', hp_choice('epsb_conv2', [0])),
                                                               ('momw', 0.9),
                                                               ('momb', 0),
                                                               ('wc', hp_choice('wc_conv2', [0.0005]))])),
                                        ('rnorm2', OrderedDict([('scale', hp_choice('rnorm2_scale', [1e-2, 1e-3, 1e-4])),
                                                                ('pow', hp_uniform('rnorm2_pow', 0.6, 0.95))])),
                                        ('conv3', OrderedDict([('epsw', hp_choice('epsw_conv3', [1e-1])),
                                                               ('epsb', hp_choice('epsb_conv3', [0])),
                                                               ('momw', 0.9),
                                                               ('momb', 0),
                                                               ('wc', hp_choice('wc_conv3', [0.0005]))])),
                                        ('rnorm3', OrderedDict([('scale', hp_choice('rnorm3_scale', [1e-2, 1e-3, 1e-4])),
                                                                ('pow', hp_uniform('rnorm3_pow', 0.6, 0.95))])),                                                                
                                        ('conv4', OrderedDict([('epsw', hp_choice('epsw_conv4', [1e-1])),
                                                               ('epsb', hp_choice('epsb_conv4', [0])),
                                                               ('momw', 0.9),
                                                               ('momb', 0),
                                                               ('wc', hp_choice('wc_conv4', [0.0005]))])),
                                        ('conv5', OrderedDict([('epsw', hp_choice('epsw_conv5', [1e-1])),
                                                               ('epsb', hp_choice('epsb_conv5', [0])),
                                                               ('momw', 0.9),
                                                               ('momb', 0),
                                                               ('wc', hp_choice('wc_conv5', [0.0005]))])),
                                        ('fc1', OrderedDict([('epsw', hp_choice('epsw_fc1', [1e-1])),
                                                              ('epsb', hp_choice('epsb_fc1', [1e-1])),
                                                              ('momw', 0.9),
                                                              ('momb', 0.9),
                                                              ('wc', hp_choice('wc_convfc1', [0.0005]))])),
                                        ('fc2', OrderedDict([('epsw', hp_choice('epsw_fc2', [1e-1])),
                                                              ('epsb', hp_choice('epsb_fc2', [1e-1])),
                                                              ('momw', 0.9),
                                                              ('momb', 0.9),
                                                              ('wc', hp_choice('wc_convfc2', [0.0005]))])),
                                        ('fc10', OrderedDict([('epsw', hp_choice('epsw_fc10', [1e-1])),
                                                              ('epsb', hp_choice('epsb_fc10', [1e-1])),
                                                              ('momw', 0.9),
                                                              ('momb', 0.9),
