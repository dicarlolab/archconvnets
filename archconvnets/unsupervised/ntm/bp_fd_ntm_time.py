...
def forward_pass(W,ww1,ww2, ww3, o_prev, ow_prev, mem_prev,x_cur):
	G = [None]*3
	O = [None]*3
	...
	return O,ow,mem,read_mem,G,gw1,gw2,gw3,ow_in,ow_sq
...
def f(y):
	...
	for frame in range(1,N_FRAMES+1):
		O, ow_prev, mem_prev, read_mem = forward_pass(W,ww1,ww2, ww3, O[F], ow_prev, mem_prev,x[frame])[:4]
...
def g(y):
	...
	for frame in range(1,N_FRAMES+1):
		# forward
		O,ow,mem,read_mem,G,gw1,gw2,gw3,ow_in,ow_sq = forward_pass(W, ww1,ww2, ww3, O_PREV[F], ow_prev, mem_prev,x[frame])
