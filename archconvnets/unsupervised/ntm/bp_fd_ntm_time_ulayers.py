...
def do_dw__inputs(W, o_prev, OUNDER, DO_DWUNDER, O, DO_DW, mem_prev, do_do_in):
	...
	dg3under_dw2under = mult_partials(dg3under_dg2under, dg2under_dw2under,  np.squeeze(OUNDER[L2_UNDER]))
	...
	DO_DWUNDER_NEW[F_UNDER] += mult_partials(do_dg3under, dg3under_dw3under, np.squeeze(OUNDER[F_UNDER]))
	DO_DWUNDER_NEW[L2_UNDER] += mult_partials(do_dg3under, dg3under_dw2under, np.squeeze(OUNDER[F_UNDER]))
...
def mem_partials(DMEM_PREV_DWW, DMEM_PREV_DWUNDER, DOW_DWW, DOW_DWUNDER, OW_PREV, OUNDER_PREV, WW):
	...
	##
	dg3under_dg2under = sq_dlayer_in_nsum(WUNDER[F_UNDER], OUNDER_PREV[L2_UNDER])
	dg2under_dw2under = sq_dF_nsum(WUNDER[L2_UNDER], OUNDER_PREV[L1_UNDER], OUNDER_PREV[L2_UNDER])
	dg3under_dw2under = mult_partials(dg3under_dg2under, dg2under_dw2under,  np.squeeze(OUNDER_PREV[L2_UNDER]))
	###
	
	DMEM_PREV_DWUNDER_NEW[F_UNDER] += mult_partials(da_dg3under, dg3under_dw3under, np.squeeze(OUNDER_PREV[F_UNDER]))
	DMEM_PREV_DWUNDER_NEW[L2_UNDER] += mult_partials(da_dg3under, dg3under_dw2under, np.squeeze(OUNDER_PREV[F_UNDER]))
