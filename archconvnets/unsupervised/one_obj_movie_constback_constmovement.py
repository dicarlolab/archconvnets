...
def get_two_movie_obj_latents(tdict, models, categories):
    ...
    for frame in range(n_frames + n_frames_stagger):
        ...
        if (frame < n_frames) and l['show_front_object'] == True:
            ...
            l['front_ty'] = front_y_steps[frame_pos]
            l['front_tz'] = front_x_steps[frame_pos]
            l['front_tx'] = front_z_steps[frame_pos]
        else:
        ...
        if (frame >= n_frames_stagger) and l['show_back_object'] == True:
            l['back_rxz'] = back_rxz[0]#frame - n_frames_stagger]
            l['back_rxy'] = back_rxy[0]#frame - n_frames_stagger]
            l['back_ryz'] = back_ryz[0]#frame - n_frames_stagger]
            l['back_ty'] = back_y_steps[0]#frame - n_frames_stagger]
            l['back_tz'] = back_x_steps[0]#frame - n_frames_stagger]
            l['back_tx'] = back_z_steps[0]#frame - n_frames_stagger]
        else:
...
templates_g = [
                 {'n_objects': 2,
                  ...
                  'template': {'bgname': choice(MOVIE_BACKGROUNDS), 'frame_pos': uniform(0,n_frames-1),
...
# rsync -avz rotating_objs32_constback_const_movement_25t/ 18.93.13.151:/home/darren
