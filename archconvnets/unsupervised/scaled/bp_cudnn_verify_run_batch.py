...
sigma31 = np.load('/home/darren/sigma31_4.npy')#.mean(-1).mean(-1).reshape((N_C, n1, 3, s1, s1, n2, s2, s2, n3, s3, s3, 1, 1))
#sigma31 = np.load('/home/darren/sigma31_4.npy').mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).reshape((N_C, n1, 3, s1, s1, 1, 1, 1, 1, 1, 1, 1, 1))

#sigma31 = np.load('/home/darren/sigma31_4.npy').mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).mean(-1).ravel()#.reshape((N_C, n1, 3, s1, s1, 1, 1, 1, 1, 1, 1, 1, 1))
