...
obj_offset = np.int(sys.argv[2])

for f in range(61):
    t_start = time.time()
    zebra.append(app.loader.loadModel(path + objs[obj_offset+f] + '/' + objs[obj_offset+f]))
...
savemat('/home/darren/new_movies2/' + str(sys.argv[1]) + '.mat', {'imgs': imgs, 'bg_list': bg_list, 'obj_list': obj_list + obj_offset})
