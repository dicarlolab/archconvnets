...
static PyObject *dsharpen_dw(PyObject *self, PyObject *args){
	cudaError_t err;
	...
	dsharpen_dw_kernel <<< dim0, dim1*dim1, sizeof(float)*(dim1 + 1) >>> (gpu_buffers[gpu_ind][w_ind], gpu_buffers[gpu_ind][gamma_ind], 
