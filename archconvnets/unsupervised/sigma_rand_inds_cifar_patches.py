...
patches_accum = np.zeros((N_IMGS*6, N_INDS_KEEP),dtype='single')
...
for batch in range(1,7):
	...
	patches_accum[(batch-1)*N_IMGS:batch*N_IMGS] = copy.deepcopy(patches)
	...
	t_start = time.time()
	sigma11 += compute_sigma11_gpu(patches) / N_IMGS
...
savemat('/home/darren/sigmas_train_test_' + str(N) + '_' + str(N_INDS_KEEP) + '.mat',{'sigma11':sigma11, 'sigma31':sigma31, 'patches':patches_accum,'labels':labels, 'inds_keep':inds_keep})
