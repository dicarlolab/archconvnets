...
k = np.load('/home/darren/archconvnets/archconvnets/unsupervised/movies/nat_segment/L3_labels')
z['labels'] = np.int32(k['labels_ravel'])
z['data'] = z['data'][:, k['frames_ravel']]
N_BP_IMGS = len(np.unique(z['labels']))
N_C = N_BP_IMGS
...
file_name = '/home/darren/F1_' + str(N_C) + '_' + str(EPS_E) + 'eps_' + str(N) + 'N.mat'
