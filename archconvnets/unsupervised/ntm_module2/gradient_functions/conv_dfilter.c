static PyObject * conv_dfilter(PyObject *self, PyObject *args){
	...
	long intended_buffer_sz = n_output*n_filters*n_channels*filter_sz*filter_sz * DATA_TYPE_SZ;
	...
	if(-1 == PyTuple_SetItem(tuple, 0, Py_BuildValue("i", n_output))) return NULL;
