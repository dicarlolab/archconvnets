...
def einsum_cat_pairs(sigma31, FL321):
	...
	return _sigma31_layers.einsum_cat_pairs(sigma31, FL321).reshape((FL321.shape[0], FL321.shape[0]))

def einsum_cat_pairs_gpu(sigma31, F1, F2, F3, FL):
	assert sigma31.dtype == np.dtype('float32')
