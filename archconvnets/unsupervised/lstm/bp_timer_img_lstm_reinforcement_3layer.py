...
F2 = np.single(np.random.normal(scale=F2_scale, size=(n2f, n1f, s2, s2)))
F3 = np.single(np.random.normal(scale=F3_scale, size=(n3f, n2f, s3, s3)))

max_output_sz3 = 5

## l1
FCm = np.single(np.random.normal(scale=FL_scale, size=(n1, n3f, max_output_sz3, max_output_sz3)))
FCi = np.single(np.random.normal(scale=FL_scale, size=(n1, n3f, max_output_sz3, max_output_sz3)))
FCo = np.single(np.random.normal(scale=FL_scale, size=(n1, n3f, max_output_sz3, max_output_sz3)))
FCf = np.single(np.random.normal(scale=FL_scale, size=(n1, n3f, max_output_sz3, max_output_sz3)))
...
B2f = np.single(np.random.normal(scale=FL2_scale, size=n2))
...
B3f = np.single(np.random.normal(scale=FL3_scale, size=n3))
