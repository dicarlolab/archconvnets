...
def test_grad_grad(x):
	...
	if np.isnan(loss) == False:
		savemat('slowness_filters_l2.mat', {'filters':filters})
	else:
		print 'nan, not saved'
...
if False:
	...
	savemat('conv_derivs_l2.mat', {'output_deriv': output_deriv})
	print 'saved'
else:
	output_deriv = loadmat('conv_derivs_l2.mat')['output_deriv']
###
