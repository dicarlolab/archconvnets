...
def init_model():
	...
	for init in [0,1]:
		...
		add_linear_F_bias_layer(LAYERS, 'CAT', 7, source='OUT2', init=init)
		...
		add_linear_F_bias_layer(LAYERS, 'OBJ', 91, source='OUT2', init=init)
		...
		add_linear_F_bias_layer(LAYERS, 'STACK_SUM4', N_TARGET, source='OUT2', init=init)
	...
	MEM_INDS = find_layer(LAYERS, ['CEC1'])
