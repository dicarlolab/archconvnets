...
def init_model():
	...
	for init in [0,1]:
		...
		add_sigmoid_F_bias_layer(LAYERS, 'CIFAR2', 20, batch_imgs=True, init=init)
		add_sigmoid_F_bias_layer(LAYERS, 'CIFAR3', 20, source='CIFAR', batch_imgs=True, init=init)
		add_add_layer(LAYERS, 'STACK_SUM2', ['CIFAR2', 'CIFAR3'], init=init)
		...
		add_pearson_layer(LAYERS, 'CIFAR_ERR', ['STACK_SUM2', -1], batch_imgs=True, init=init)
