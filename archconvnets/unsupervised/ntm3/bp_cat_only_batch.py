...
from architectures.ctt_categorization_only_batch import *
...
SAVE_FREQ = 10000/(BATCH_SZ) #50 #250 # instantaneous checkpoint
...
while True:
	...
	for img in range(BATCH_SZ):
		...
		movie_inputs[img] = z['imgs'][movie_frame-N_CTT:movie_frame].reshape((1,N_CTT*3, IM_SZ, IM_SZ))
	
	movie_inputs = np.ascontiguousarray(movie_inputs - .5)
